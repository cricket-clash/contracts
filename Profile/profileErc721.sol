...
contract Cricket_Clash_Profile_NFT is ERC721AQueryable, AccessControl {
	
	string public _baseTokenURI = "http://3.110.62.247/pitch/token/";
	
	bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
	
	address public upgradedToAddress = address(0);
	
	constructor() ERC721A("Cricket Clash Profile NFT", "CCPN") {
